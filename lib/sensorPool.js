...
var _ObjectSensor = require('./sensor/ObjectSensor');

var _ObjectSensor2 = babelHelpers.interopRequireDefault(_ObjectSensor);
...
var getSensor = exports.getSensor = function getSensor(element) {
  ...
  var sensor = new _ObjectSensor2.default(element);
  // 添加到池子中
